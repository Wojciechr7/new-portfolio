...
```sh
    ...
    MyProjects Console: https://console.firebase.google.com/project/example-app-fd690/overview
    Hosting URL: https://example-app-fd690.firebaseapp.com
```

For more information see [Add Firebase to your JavaScript MyProjects](https://firebase.google.com/docs/web/setup).
